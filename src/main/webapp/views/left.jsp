			...
			<td width="182" valign="top">
				<div id="container">
					...
					<div class="content">
						...
						<ul class="MM">
							<li><a href="login.jsp" target="main">基本设置</a></li>
					...
					<div class="content">
						...
						<ul class="MM">
							<li><a href="/book/audit/auditView.action?pageNo=1&pageSize=10" target="main">查看日志</a></li>
						</ul>
					</div>
					<h1 class="type">
						<a href="javascript:void(0)">图书内容管理</a>
					</h1>
					<div class="content">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
						...
						<ul class="MM">
							<li><a href="/book/book/bookView.action?pageNo=1&pageSize=10" target="main">图书信息管理</a></li>
							<li><a href="manage/book.html?pageNo=1" target="main">查看图书列表</a></li>
							<li><div id="name"><a href="manage/book.html?pageNo=1" target="main">管理商家</a></div></li>
							<li><a href="manage/book.jsp" target="main">发布资讯</a></li>
							<li><a href="manage/bookAdd.html" target="main">资讯管理</a></li>
